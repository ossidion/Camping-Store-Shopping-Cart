...
class Item:
    ...
    is an item which can be added to the shopping cart. The class is
    initialized with the following instance variables:
        - name of item
        - price of item
        - stock count of item
        - quantity of item, which can be used as a counter for the number
          of this item type the user has within their shopping cart.)

    This item clsss includes the following methods:
        - def __str__(self):
        - def __repr__(self):
    ...
    def __str__(self):
        """Returns a string representation of an Item object and its
        attributes.
        """
